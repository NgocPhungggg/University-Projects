...
{
    public partial class Form_MenuReceptionist : Form
    {
        public Form_MenuReceptionist()
        {
            InitializeComponent();
        }
        Janitor receptionist = new Janitor();
        Attendance attendance= new Attendance();
        string ID;
        public void GetReceptionistID(string id)
        {
            ID = id;
        }
        private void Form_MenuReceptionist_Load(object sender, EventArgs e)
        {
        ...
        private void Button_ReservedRoom_Click(object sender, EventArgs e)
        {
            Form_ReservedRoom reservedroom = new Form_ReservedRoom();
            reservedroom.ShowDialog();
        }
